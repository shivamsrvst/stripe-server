...
router.post("/create-checkout-session", async (req, res) => {
  ...
  const session = await stripe.checkout.sessions.create({
    ...
    success_url: "https://stripe-server-production-531f.up.railway.app/stripe/checkout-success",
    cancel_url:  "https://stripe-server-production-531f.up.railway.app/stripe/cancel",
  });
